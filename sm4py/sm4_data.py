    ...
    def read_object(self, page, obj):
        ...
        if obj.offset*obj.size != 0:
            if obj.id == 5:
                ...
                page._read_ChannelDriveInfo('RHK_OBJECT_CH1_DRIVE_INFO', 'RHK_CH1Drive')
            elif obj.id == 24:
                page._read_ChannelDriveInfo('RHK_OBJECT_CH2_DRIVE_INFO', 'RHK_CH2Drive')
            elif obj.id == 25:
                page._read_LockinInfo('RHK_OBJECT_LOCKIN0_INFO', 'RHK_Lockin0')
            elif obj.id == 26:
                page._read_LockinInfo('RHK_OBJECT_LOCKIN1_INFO', 'RHK_Lockin1')
            elif obj.id == 27:
                page._read_PIControllerInfo('RHK_OBJECT_ZPI_INFO', 'RHK_ZPI')
            elif obj.id == 28:
                page._read_PIControllerInfo('RHK_OBJECT_KPI_INFO', 'RHK_KPI')
            elif obj.id == 29:
                page._read_PIControllerInfo('RHK_OBJECT_AUX_PI_INFO', 'RHK_AuxPI')
            elif obj.id == 30:
                page._read_LowPassFilterInfo('RHK_OBJECT_LOWPASS_FILTER0_INFO', 'RHK_LowPassFilter0')
            elif obj.id == 31:
                page._read_LowPassFilterInfo('RHK_OBJECT_LOWPASS_FILTER1_INFO', 'RHK_LowPassFilter1')
...
class RHKPage(RHKObjectContainer):
    ...
    def __init__(self, sm4):
        ...
        self.name = "ID" + str(self.attrs['RHK_PageID'])
    ...
    def _read_StringData(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_STRING_DATA')
        self._sm4._seek(offset, 0)
    ...
    def _read_SpecDriftHeader(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_SPEC_DRIFT_HEADER')
        self._sm4._seek(offset, 0)
    ...
    def _read_SpecDriftData(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_SPEC_DRIFT_DATA')
        self._sm4._seek(offset, 0)
    ...
    def _read_ImageDriftHeader(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_IMAGE_DRIFT_HEADER')
        self._sm4._seek(offset, 0)
    ...
    def _read_ImageDrift(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_IMAGE_DRIFT')
        self._sm4._seek(offset, 0)
    ...
    def _read_ColorInfo(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_COLOR_INFO')
        self._sm4._seek(offset, 0)
    ...
    def _read_TipTrackHeader(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_TIP_TRACK_HEADER')
        self._sm4._seek(offset, 0)
    ...
    def _read_TipTrackData(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_TIP_TRACK_DATA')
        self._sm4._seek(offset, 0)
    ...
    def _read_PRMData(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_PRM')
        self._sm4._seek(offset, 0)

        if self.attrs['RHK_PRM_CompressionFlag'] == 0:
            dataSize = self.attrs['RHK_PRM_DataSize']
        elif self.attrs['RHK_PRM_CompressionFlag'] == 1:
            dataSize = self.attrs['RHK_PRM_CompressionSize']
    ...
    def _read_PRMHeader(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_PRM_HEADER')
        self._sm4._seek(offset, 0)

        self.attrs['RHK_PRM_CompressionFlag'] = self._sm4._readb(np.uint32, 1)
        self.attrs['RHK_PRM_DataSize'] = self._sm4._readb(np.uint64, 1)
        self.attrs['RHK_PRM_CompressionSize'] = self._sm4._readb(np.uint64, 1)

    def _read_APIInfo(self):
        # Read API Info for the current page.

        offset = self._header._get_offset('RHK_OBJECT_API_INFO')
        self._sm4._seek(offset, 0)
    ...
    def _read_HistoryInfo(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_HISTORY_INFO')
        self._sm4._seek(offset, 0)
    ...
    def _read_PiezoSensitivity(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_PIEZO_SENSITIVITY')
        self._sm4._seek(offset, 0)
    ...
    def _read_FrequencySweepData(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_FREQUENCY_SWEEP_DATA')
        self._sm4._seek(offset, 0)
    ...
    def _read_ScanProcessorInfo(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_SCAN_PROCESSOR_INFO')
        self._sm4._seek(offset, 0)
    ...
    def _read_PLLInfo(self):
        ...
        offset = self._header._get_offset('RHK_OBJECT_PLL_INFO')
        self._sm4._seek(offset, 0)
